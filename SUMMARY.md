...
* [Regular and expiring TODOs](core-concepts/regular-and-expiring-todos.md)
...
* [Date](triggers/date.md)
* [GitHub Issue closed](triggers/github-issue-closed.md)
...
* [Enforce expiring TODOs](configuration/enforce-expiring-todos.md)
* [Rules](configuration/rules.md)
* [Exclusion list](configuration/exclusion-list.md)
